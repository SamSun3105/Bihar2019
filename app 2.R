...
Electoral165 <- data.frame(read.csv("data/Electoral165.csv",stringsAsFactors=F,header=T))
Electoral166 <- data.frame(read.csv("data/Electoral_166.csv",stringsAsFactors=F,header=T))
Electoral168 <- data.frame(read.csv("data/Electoral_168.csv",stringsAsFactors=F,header=T))
Electoral178 <- data.frame(read.csv("data/Electoral_178.csv",stringsAsFactors=F,header=T))
Electoral179 <- data.frame(read.csv("data/Electoral179.csv",stringsAsFactors=F,header=T))
Electoral167 <- data.frame(read.csv("data/surjgrah.csv",stringsAsFactors=F,header=T))
Candidatedata <- (read.csv("data/Candidatedata.csv"))
Assemblywise <- as.data.frame(read.csv("data/PC28.csv"))
BoothWise165 <- as.data.frame(read.csv("data/pollingBoothwiseResult165.csv"))
BoothWiseResult165 =select(BoothWise165,1,3,4,24,26)
Expense <- as.data.frame(read.csv("data/Expenditure_Analysis.csv"))
